...
Run:
  python roc_colors_cnn1d_4settings.py \
    --blue_zip "data/blue 100x 10Hz.zip" \
    --red_zip "data/Red 100x 10Hz.zip" \
    --green_zip "data/Green 100x 13Hz.zip" \
    --neg_zip "data/not_RED_speaking.zip" \
    --out_dir outputs/results_roc_nn \
    --epochs 40 \
    --batch_size 16 \
    --lr 1e-3 \
    --font_size 18 \
...
def parse_args():
    ...
    p.add_argument("--blue_zip", type=str, default="data/blue 100x 10Hz.zip")
    p.add_argument("--red_zip", type=str, default="data/Red 100x 10Hz.zip")
    p.add_argument("--green_zip", type=str, default="data/Green 100x 13Hz.zip")
    p.add_argument("--neg_zip", type=str, default="data/not_RED_speaking.zip")

    p.add_argument("--out_dir", type=str, default="outputs/results_roc_nn")
