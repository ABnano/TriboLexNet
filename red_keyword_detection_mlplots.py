...
def parse_args():
    ...
    p.add_argument("--red_zip", type=str, default="Red_story_231125.zip")
    p.add_argument("--not_red_zip", type=str, default="not_RED_speaking.zip")
    ...
    p.add_argument("--out_dir", type=str, default="results_mlplots")
